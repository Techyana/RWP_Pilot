// src/components/admin/DeleteDeviceModal.tsx
...
export const DeleteDeviceModal: React.FC<DeleteDeviceModalProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      // ← use deleteDevice, not removeDevice
      await api.device.deleteDevice(device.id, reason)
    ...
    <>
      ...
      <div className="space-y-4">
        <p className="text-gray-700 dark:text-gray-300">
          Are you sure you want to mark this device as removed? This action
